...
def init(w, h, title):
    ...
    Game.font2 = pygame.font.Font("assets/Font/Monocraft.otf", 26)  # set up fonts for further use
    ...
    Game.playsurf = pygame.image.load("assets/Images/tug_of_war.png").convert_alpha()  # loads images
...
def tugOfWar():
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
                return;  # allows closing the program after the previous loop is broken
