        ...
        for row in range(7):
            for col in range(6):
                ...
                try:
                    ...
                    elif board[row][col] == 1 and board[row][col+1] == 1 and board[row][col+2] == 1 and board[row][col+3] == 1:
                        screen.blit(rwin,rwinr)
                        kill+=1
                        break

                    elif board[row][col] == 1 and board[row+1][col+1] == 1 and board[row+2][col+2] == 1 and board[row+3][col+3] == 1:
                        screen.blit(rwin,rwinr)
                        kill+=1
                        break
